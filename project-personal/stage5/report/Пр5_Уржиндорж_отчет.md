...
Создаю записи по своему проекту на тему "AI_Arrow", редактируя файл index.md, находяшийся в папке по адресу /home/muagmar-urzhindorzh/work/blog/content/project (рис. [-@fig:001]).
